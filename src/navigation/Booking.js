...
const Booking = () => {
  ...
  return (
    ...
    <FlatList style={{alignContent:'center',marginLeft:30}}
      ...
      data={[
        {name: 'Go Online General',desc:'Lorem ipsum dolor sit amet...',path: require('../images/b1.png')},
        {name: 'Individual',desc:'Aenean lectus enim',path: require('../images/b2.png')},
        {name: 'Group',desc:'Aliquam eu tellus ut lorem porta hendr...',path: require('../images/b3.png')},
        {name: 'Business    ',desc:'Quisque elementum nisi ut orci ornare',path: require('../images/b4.png')},
       
      ]}
      renderItem={({item}) =>{
        return<View style={{flexDirection:'row'}}>
        <View>
         <Image style={{marginTop:30}} source={item.path} />
         </View>
